...
class Transaction(object):
    def __init__(self):
        ...
        names_list = self.read_data(d+"/test_data/wild_cats.txt")
        self.post_body = {"species": names_list}
    ...
    def run(self):
        ...
        response = requests.post("http://phylo.cs.nmsu.edu:5004/phylotastic_ws/si/eol/images", data=jsonPayload, headers={'content-type': 'application/json'})
