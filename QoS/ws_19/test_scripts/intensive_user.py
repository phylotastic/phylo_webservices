...
class Transaction(object):
    def __init__(self):
        ...
        names_list = self.read_data(d+"/test_data/flower_plants.txt")

        self.post_body = {"resolvedNames": names_list}
    ...
    def run(self):
        ...
        response = requests.post("http://phylo.cs.nmsu.edu:5004/phylotastic_ws/gt/pt/tree", data=jsonPayload, headers={'content-type': 'application/json'})
