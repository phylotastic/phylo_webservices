...
def json_return(data, status_code, response): 
    #print data
...
def get_tree_image():
    ...
    if not tree_newick or not tree_id:
        return json_return({'status_code': 400, 'message': "Missing Parameter Error: No newick tree or tree id provided"}, 400, response)
    ...
    return json_return({'tree_newick':tree_handler.treenewick, 'tree_id':tree_handler.treeid, 'html_data': html_img_data, 'actions':{'tree_actions':{}, 'node_actions':[]}}, 200, response)
