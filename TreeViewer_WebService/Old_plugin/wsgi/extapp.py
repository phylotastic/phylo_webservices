...
class WebTreeApplication(object):
    ...
    def __init__(self):
        ...
        self.queries = {}
        self.CONFIG = {
            "temp_dir":"/var/www/html/TreeViewer/tmp",
            "temp_url":"http://phylo.cs.nmsu.edu:8080/TreeViewer/tmp",
    ...
    def _get_html_map(self, img_map, treeid, mapid, tree):
        ...
        html_map += '</MAP>'
        #print ("_get_html_map exiting")
        return html_map

    def _load_tree(self, treeid, tree=None, cache_file=None):
        #print ("_load_tree called treeid: %s; tree: %s; cache_file: %s" %(str(treeid),tree,cache_file) )
    ...
    def _load_tree_from_path(self, pkl_path):
        #print ("_load_tree_from_path called with pkl_path: %s" %(pkl_path) )
    ...
    def _dump_tree_to_file(self, t, treeid):
        #print ("_dump_tree_to_file called")
    ...
    def _get_tree_img(self, treeid, pre_drawing_action=None):
        #print ("_get_tree_img called with pre_drawing_action: %s" %(str(pre_drawing_action)) )
