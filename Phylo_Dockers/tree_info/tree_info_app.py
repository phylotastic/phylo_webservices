...
from service import compare_trees_service
from service import tree_studies_service
from service import compound_service_tree
#--------------------------------------------------

WS_NAME = "phylotastic_ws"
WS_GROUP1 = "md" #metadata service
WS_GROUP2 = "cp" #compound service
...
if __name__ == '__main__':
    ...
    cherrypy.tree.mount(Compound_Service_Tree_API(), '/%s/%s/%s' %(str(WS_NAME),str(WS_GROUP2), "gt"), conf_CORS )
