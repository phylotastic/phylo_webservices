...
from . import scientific_to_common_name_NCBI
from . import scientific_to_common_name_EOL
from . import scientific_to_common_name_GNR
...
#-------------------------------------
	...
	#print (get_common_name_tree(input_tree, "EOL", False))
